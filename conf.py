...
BLOG_AUTHOR = "Barry Price"  # (translatable)
BLOG_TITLE = "Barry Price"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://barryprice.uk/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://barryprice.net/"
BLOG_EMAIL = "anon@anon.no"
BLOG_DESCRIPTION = "Barry Price"  # (translatable)
...
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="https://barryprice.uk">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
RSS_COPYRIGHT = 'Contents © {date} <a href="https://barryprice.uk">{author}</a> {license}'
